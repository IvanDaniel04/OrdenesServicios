...
public class HelloController {
    ...
    @FXML private PasswordField psFContrasena;
    @FXML private Label labAlertaCorreo;
    @FXML private Label labAlertaContrasena;
    @FXML private Label labAlerta;
    @FXML private Button btnInciciar;
           ...
           labAlertaContrasena.setVisible(true);
            ...
            try{
                ...
                if (rs.next()){
                    ...
                    HelloApplication.setVista("registros");
                }else{
